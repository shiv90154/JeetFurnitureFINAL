...
const TermsConditions = () => (
  <Container maxWidth="md" sx={{ py: { xs: 4, sm: 6 } }}>
    ...
    <Box sx={{ mb: 6 }}>
      ...
      <Typography variant="body1" color="text.secondary" paragraph>
        Welcome to Dr. BSK&apos;s UK German Pharmaceuticals (&quot;Company&quot;, &quot;we&quot;, &quot;our&quot;, or &quot;us&quot;). By accessing our website <b>www.ukgermanpharmaceuticals.com</b> (&quot;Website&quot;), you agree to comply with and be bound by the following Terms and Conditions. If you disagree with any part of these terms, please do not use our Website.
      </Typography>
      <TermSection
        items={[
          {
      ...
      <TermSection
        items={[
          ...
          },
          {
            ...
            content:
              "You may request access, correction, or deletion of your personal data by contacting us at contact@ukgermanpharmaceuticals.com.",
          },
          {
    ...
    <Box sx={{ mb: 2 }}>
      ...
      <Box sx={{ mt: 2 }}>
        <Typography fontWeight={600}>Dr. BSK&apos;s UK German Pharmaceuticals</Typography>
        <Typography>Cheema, Punjab – 148031, India</Typography>
        <Typography>
          Email:&nbsp;
          <Link
            href="mailto:contact@ukgermanpharmaceuticals.com"
            color="inherit"
            underline="hover"
          >
            contact@ukgermanpharmaceuticals.com
          </Link>
        </Typography>
        <Typography>
          Phone:&nbsp;
